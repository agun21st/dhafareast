...
@yield('meta')
<title>Dhaka Fareast LTD</title>
<link rel = "icon" type = "image/png" href = "http://dhakafareast.com/storage/Logos/Febicon_logo" alt="Febicon">
<!-- Google fonts -->
...
<!-- side nav -->
<link rel="stylesheet" type="text/css" href="{{URL::asset('css/mCustomScrollbar.min.css')}}">
<script src="https://use.fontawesome.com/ee24338c55.js"></script>
@yield('style')
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-156011353-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-156011353-1');
</script>
