...
Route::get('/404', function () {return view('pages.page_not_found');});


Route::get('/pws', function () {return Hash::make("raz0172834621");});

// Route::get('/index.php', function () {return "hello"; redirect('https://dhakafareast.com/');});
